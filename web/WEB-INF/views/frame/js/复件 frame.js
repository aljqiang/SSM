...
var topHeight = 80;//92// 顶部帧高度

var showAnnouncements = false;	//是否显示公告栏
...
function onResizeHandler(){
	...
	contentDoc.find('div[id*="subMenu"]').height($('#menuFrame').height() - contentDoc.find('li.menuItem').height()* contentDoc.find('li.menuItem').size());
...
var AnnouncePanel = function(){
	...
	var thisObj = {
		init:function(){
			var aDiv = $('<div id="announcements" class="announcements"><h4><div class="title_announcement">公告栏</div><div id="announce_btn1" class="btn_collapse"></div></h4><div class="announce_content"></div></div>');
